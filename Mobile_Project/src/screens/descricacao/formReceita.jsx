...
export default function Formulario_Rec() {
    ...
    const handleAdReceita = async (event) => {
        axios
            .post('http://localhost:5000/receita_controller/post', {
                data: date,
                categoria: categoria,
                descricao: descricao,
                valor: valor,
        ...
        <View style={styles.container}>
            <ScrollView>
                <View style={{ marginTop: 40 }}>
                    ...
                    <TouchableOpacity
                        onPress={(event) => handleAdReceita(event)}
                    >
